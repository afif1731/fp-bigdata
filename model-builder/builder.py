...
s3_file_path = f"http://localhost:9001/{AWS_BUCKET_NAME}/bronze/hospitaldb/{today}/patient_readmissions/part-00000-4288396d-aa41-4bf8-8e72-d82f49ebfaec-c000.snappy.parquet"

s3 = boto3.client(
    "s3",
    aws_access_key_id=AWS_ACCESS_KEY,
    aws_secret_access_key=AWS_SECRET_KEY,
    endpoint_url="http://localhost:9001",  # Untuk MinIO
)
